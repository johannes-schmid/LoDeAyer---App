    ...
    <div className="px-5 pt-2 pb-6 space-y-5">
      ...
      <div className="bg-[#111113] border border-white/[0.06] rounded-2xl p-5">
        ...
        <div className="flex justify-center mb-4">
          <a href="/evento/demo" className="w-32 h-32 bg-white rounded-xl flex items-center justify-center p-2.5 hover:ring-2 hover:ring-[#d9b98a]/60 transition-all cursor-pointer">
