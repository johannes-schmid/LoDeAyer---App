...
export default function Hero() {
  ...
  return (
    <>
      <section className="relative min-h-[600px] h-[100dvh] flex flex-col justify-end overflow-hidden">
        <img
        ...
        {/* Content — bottom left */}
        <div className="relative z-10 max-w-6xl mx-auto w-full px-5 md:px-8 pb-12 md:pb-20">
          {/* Eyebrow */}
          ...
          {/* Headline */}
          <h1 className="font-serif font-bold text-[#f4efe7] text-5xl md:text-7xl lg:text-8xl leading-[1.0] mb-0 max-w-2xl">
            Tu boda, tu día,
          </h1>
          <h1 className="font-serif italic text-[#d9b98a] text-5xl md:text-7xl lg:text-8xl leading-[1.0] mb-6 max-w-3xl">
            visto con los ojos de todos.
          </h1>

          {/* Subtext */}
          <p className="text-[#f4efe7]/65 text-sm md:text-lg max-w-sm mb-8 leading-relaxed">
